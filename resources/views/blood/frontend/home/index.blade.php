            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 text-center">
                    <div class="banner-content">
                        ...
                        <a href="{{ route('donor.register') }}" class="btn btn-slider">Donner Registration</a>   
                    </div>
                </div> <!-- end .col-md-12  -->
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" placeholder="Enter Area Name" class="form-control" style="height: 35px;">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                            ...
                            <table class="table table-bordered table-hover table-primary" id="dtTable">
                                ...
                                @foreach($donors as $donor)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $donor->name }}</td>
                                        <td style="text-align: center;"><i class="fa fa-phone"></i> <a href="tel:{{ $donor->phone }}" <span style="color:#000">{{ $donor->phone }}</span></a></td>
